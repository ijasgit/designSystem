...
export default function SignInSide() {
  ...
  return (
    <ThemeProvider theme={defaultTheme}>
      <Grid container component="main" sx={{ height: "80vh", mt: 8 ,boxSizing:" border-box",
    display: "webkit-box", marginLeft: isXsScreen ? 5 : "115px", }}>
        <CssBaseline />
        <Grid
          component={Paper}
          elevation={5}
        ...
        <Grid item xs={10} sm={7} md={4} component={Paper} elevation={5} square
        sx={{
